...
if($tinggi_badan==NULL && $berat_badan==NULL){
    $eror= "tinggi dan berat tidak boleh kosong";
} 
...
// silakan taruh code kalian di bawah
if(empty($error)){
    $hasiltinggi = $tinggi_badan/100;
    $hasilberat = $berat_badan/100;
    $bmi = $hasiltinggi / ($hasilberat**2);   
}
if ($bmi <= 18.4) {
    $status = "Underweight";
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                    if(isset($eror)) {
                        echo "tinggi dan berat tidak boleh kosong : " . $eror;
